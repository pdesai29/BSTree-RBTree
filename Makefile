trees: main.o rb_tree.o bs_tree.o random_generator.o timer.o sort.o
	g++ -Wall -std=c++11 main.o rb_tree.o bs_tree.o random_generator.o timer.o sort.o -o trees
